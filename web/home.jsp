			...
			<div class="carousel-item item2">
				<div class="container">
					<div class="w3l-space-banner">
						<div class="carousel-caption p-lg-5 p-sm-4 p-3">
							<p>Ecouteurs
								<span>Sans fil</span> avancés</p>
							<h3 class="font-weight-bold pt-2 pb-lg-5 pb-4">Meilleurs
								<span>Ecouteurs</span>
							</h3>
							<a class="button2" href="product.html">Acheter Maintenant</a>
						</div>
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
                                            ...
                                            <div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                <form action="#" method="post">
                                                    <fieldset>
                                                        ...
                                                        <input type="hidden" name="amount" value="${produit.prix + 1}" />
						...
						<!-- second section -->
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Réfrigérateur</h3>
							<div class="row">
                                                            <c:forEach var="produit" items="${produitMachine}">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/${produit.produitImg}" alt="">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                ...
                                                <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Machine à lavé</h3>
							<div class="row">
                                                            <c:forEach var="produit" items="${produitElectro}">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/${produit.produitImg}" alt="">
										...
										<div class="item-info-product text-center border-top mt-4">
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
                                                ...
                                                <div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Top Promo pour HiTeMa</h3>
							<div class="row">
                                                            <c:forEach var="produit" items="${produitMachine}">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
